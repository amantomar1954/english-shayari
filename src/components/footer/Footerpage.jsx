            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <motion.div variants={itemVariants} className="lg:col-span-1">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-6">
                 India's largest Shayari platform. Here you'll find beautiful Shayaris, poems, and words filled with emotions.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <motion.div variants={itemVariants} className="text-center md:text-left">
                <p className="text-gray-600 mb-2">© 2025 English Shayari. All rights reserved.</p>
              ...
              <motion.div variants={itemVariants} className="flex items-center space-x-4">
                ...
                {socialLinks.map((social) => (
                  <Link key={social.name} href={social.href}>
                    <motion.div
                      className={`p-3 rounded-full border border-gray-200 ${social.color} ${social.bgColor} transition-all shadow-sm hover:shadow-md`}
